                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
                    ...
                    <div>
                        ...
                        <div className="mt-8 flex flex-wrap items-center gap-4">
                            ...
                            <a
                                href={`https://wa.me/905320000000?text=${encodeURIComponent(`Merhaba, "${product.title}" ürünü hakkında bilgi almak istiyorum.`)}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center gap-2 px-8 py-3.5 rounded-md bg-green-500 text-white text-sm font-bold uppercase tracking-wider transition-all hover:bg-green-600 hover:shadow-lg hover:shadow-green-200"
                            >
