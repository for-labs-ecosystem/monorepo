            ...
            <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-[0_32px_80px_-12px_rgba(0,0,0,0.22)] overflow-hidden animate-fade-in-up flex flex-col max-h-[92dvh]">
                ...
                {status === 'success' ? (
                    ...
                    <div className="flex flex-col sm:flex-row overflow-auto">
                        ...
                        <div className="sm:w-72 shrink-0 bg-gradient-to-br from-frost-50 to-azure-50/20 flex flex-col border-b sm:border-b-0 sm:border-r border-slate-100">
                            {/* Product image */}
                            <div className="h-52 sm:h-64 flex items-center justify-center p-8 bg-gradient-to-br from-azure-50/40 via-white to-frost-50/60">
                                {imgSrc ? (
                                    <img
                                        src={imgSrc}
                                        alt={product.title}
                            ...
                            <div className="p-6 space-y-4 flex flex-col flex-1">
                                <div>
                                    <p className="text-[10px] font-bold text-azure-500 uppercase tracking-widest mb-1">Sipariş İstenen Ürün</p>
                                ...
                                {priceLabel && (
                                    <div className="mt-auto pt-4 border-t border-slate-100">
                                        ...
                                        <p className="text-xl font-bold text-azure-600">{priceLabel}</p>
                                        <p className="text-[10px] text-slate-400 mt-0.5">Sipariş tutarı onaya tabidir</p>
                                    </div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex-1 flex flex-col overflow-auto">
                            <div className="p-7 lg:p-9">
                                <h2 className="text-xl font-bold text-slate-700 mb-1">Sipariş Formu</h2>
                                <p className="text-[13px] text-slate-400 mb-7 leading-relaxed">
                                    Bilgilerinizi doldurun, siparişinizi tamamlamak için ekibimiz en kısa sürede sizinle iletişime geçsin.
                                </p>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <button
                                        ...
                                        className="w-full btn-azure disabled:opacity-40 disabled:cursor-not-allowed mt-1"
                                    >
                                        {status === 'sending' ? (
